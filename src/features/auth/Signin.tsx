      ...
      <div className="w-full min-h-[700px] max-w-6xl grid lg:grid-cols-2 p-4 lg:p-8">
         ...
         <div className="bg-white p-6 lg:p-12 rounded-3xl lg:rounded-l-none shadow-xl">
          <>
            ...
            <h2 className="text-2xl font-bold mb-2 text-[#C09239] text-center">GOT YOUR BACK</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <label htmlFor="remember" className="text-sm font-poppins text-gray-600">
                    Remember me
                  </label>
                </div>
                <Link to="/forgot-password" className="text-sm font-poppins text-[#C09239] hover:text-[#aa8233]">
                  Forgot Password?
                </Link>
              </div>
              ...
              <div className="text-center mt-4">
                <span className="text-gray-600 font-poppins">Not Registered Yet? </span>
                <Link to="/user_sign_up" className="text-[#C09239] font-poppins hover:text-[#aa8233]">
                  Create Account
                </Link>
              </div>
            </form>
